...
- The goals is to be able to pip install this package, and be able to call find_bad_actors()
...
│
├── pyproject.toml     <- Project configuration file with package metadata for catchmeifyoucan
...
│
└── catchmeifyoucan                <- Source code for use in this project.
    │
    ├── __init__.py    <- Makes catchmeifyoucan a Python module
    │
